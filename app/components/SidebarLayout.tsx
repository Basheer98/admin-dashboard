    ...
    <div className="dashboard-layout flex min-h-screen text-zinc-100">
      ...
      >
        ...
        <nav className="flex flex-1 flex-col gap-0.5" role="navigation" aria-label="Main">
          ...
          <SidebarLink href="/tickets" icon={MessageSquare} label="Tickets" active={current === "tickets"} onNavigate={!isLg ? closeMobileMenu : undefined} />
          <SidebarLink href="/email-ingest" icon={MessageSquare} label="Email ingest" active={current === "email-ingest"} onNavigate={!isLg ? closeMobileMenu : undefined} />
